...
@RestController
@RequestMapping("/safty/homePhone")
public class HomePhoneController {
	@Autowired
	private HomePhoneService homePhoneService;
	@GetMapping("/menu")
	public List<MenuDto> getMenus(){
		...
		System.out.println("<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<");
		return homePhoneService.getMenus(currUser);
	}
	@GetMapping("/currUser")
