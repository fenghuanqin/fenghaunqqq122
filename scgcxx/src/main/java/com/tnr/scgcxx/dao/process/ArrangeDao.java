...
public interface ArrangeDao {
	...
	List<com.tnr.scgcxx.model.Process>  findArrangeList(ProcessDto dto);
	...
	@Update("update bus_process set arrange_num=#{dto.arrange_num},arrange_date=#{currDate},arrange_person=#{currUserName},process_status='25'where process_id=#{dto.process_id}")
