...
public interface PretreatmentDao {
	...
	List<com.tnr.scgcxx.model.Process>  findPretreatmentList(ProcessDto dto);
	...
	@Update("update bus_process set pretreat_num=#{dto.pretreat_num},pretreat_date=#{currDate},pretreat_person=#{currUserName},process_status='10'where process_id=#{dto.process_id}")
