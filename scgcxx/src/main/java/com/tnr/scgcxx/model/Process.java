...
public class Process {
	...
	public String getProcess_cus() {
		...
		builder.append(cus_id).append("-").append(cus_name);
	...
	public String getProcess_std() {
		StringBuilder builder = new StringBuilder();
		builder.append(standard_id).append("-").append(standard_name);
		return builder.toString();
	}
	...
	public String getProcess_color() {
		StringBuilder builder = new StringBuilder();
		builder.append(co_id).append("-").append(co_name);
		return builder.toString();
	...
	public String getStatusName() {
		return ProcessStatusEnum.getName(process_status);
	}
	...
	public String toString() {
		return "Process [process_id=" + process_id + ", plan_id=" + plan_id + ", process_cus=" + process_cus
				+ ", process_std=" + process_std + ", process_color=" + process_color + ", group_num=" + group_num
				+ ", group_date=" + group_date + ", group_person=" + group_person + ", pretreat_num=" + pretreat_num
				+ ", pretreat_date=" + pretreat_date + ", pretreat_person=" + pretreat_person + ", dye_num=" + dye_num
				+ ", dye_date=" + dye_date + ", dye_person=" + dye_person + ", print_num=" + print_num + ", print_date="
				+ print_date + ", print_person=" + print_person + ", arrange_num=" + arrange_num + ", arrange_date="
				+ arrange_date + ", arrange_person=" + arrange_person + ", check_num=" + check_num + ", check_date="
				+ check_date + ", check_person=" + check_person + ", process_status=" + process_status + ", co_id="
				+ co_id + ", co_name=" + co_name + ", cus_id=" + cus_id + ", cus_name=" + cus_name + ", standard_id="
				+ standard_id + ", standard_name=" + standard_name + "]";
	}
